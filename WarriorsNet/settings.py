"""
Django settings for WarriorsNet project.
...
#ALLOWED_HOSTS = ['localhost', '127.0.0.1', 'warriorsnet.onrender.com']
RENDER_EXTERNAL_HOSTNAME = os.environ.get('RENDER_EXTERNAL_HOSTNAME')
if RENDER_EXTERNAL_HOSTNAME:
    ALLOWED_HOSTS.append(RENDER_EXTERNAL_HOSTNAME)

ALLOWED_HOSTS.append('warriorsnet.onrender.com')
...
WSGI_APPLICATION = 'WarriorsNet.wsgi.application'
